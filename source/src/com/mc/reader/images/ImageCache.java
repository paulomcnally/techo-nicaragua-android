...
import com.mc.reader.images.Utils;
import com.mc.reader.images.DiskLruCache;

import com.techo.nicaragua.BuildConfig;
...
public class ImageCache {
    ...
    private void init(ImageCacheParams cacheParams) {
        ...
        if (mCacheParams.memoryCacheEnabled) {
            if (com.techo.nicaragua.BuildConfig.DEBUG) {
